    ...
    <div className="p-8 max-w-7xl mx-auto h-full flex flex-col">
      <div className="flex justify-between items-center mb-4">
        <div>
          ...
          <p className="text-xs text-neutral-500 mt-0.5">Manage live benchmark rates. Saved historical costings will remain locked at their original prices.</p>
        </div>
        <button onClick={startNew} className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm font-medium transition-colors shadow-sm">
